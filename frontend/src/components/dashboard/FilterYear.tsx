...
const FilterYear: React.FC<FilterYearProps> = ({ value, onChange, className = "", style = {} }) => {
  ...
  return (
    <div className={`relative w-[200px] flex flex-col gap-1 ${className}`} ref={wrapperRef} style={style}>
      <button
